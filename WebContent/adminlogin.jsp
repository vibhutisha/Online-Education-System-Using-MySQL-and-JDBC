...
<ul>
   ...
   <li><a href='${pageContext.request.contextPath}/adminlogin.jsp'><span>Administrator Login</span></a></li>
</ul>
</div>
...
<div id="wrapper">
	...
	<form name="login-form" class="login-form" action="checkLogin2" method="post">
		...
		<div class="content">
		<input name="adminID" type="text" class="input adminID" placeholder="Admin ID" />
